...
target_raw_file = "data/TTD/P1-01-TTD_target_download.txt"
drug_raw_file = "data/TTD/P1-02-TTD_drug_download.txt"
...
df.to_csv("data/TTD_target_drugs.csv", index=False)
